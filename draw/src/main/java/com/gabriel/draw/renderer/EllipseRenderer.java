                ...
                try {
                    ...
                    if (imageFile.exists()) {
                        ...
                        if (img != null) {
                            ...
                            Ellipse2D.Double clipEllipse = new Ellipse2D.Double(x, y, width, height);
                            g2.setClip(clipEllipse);
                    ...
                    System.err.println("Error loading image in ellipse: " + ex.getMessage());
                }
            }
